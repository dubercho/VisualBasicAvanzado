    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-md-2">
            <ul style="list-style-type: none" class="nav">
                ...
                <li><a runat="server" href="#">Diseño del editor</a></li>
                <li><a runat="server" href="#">Editor de dibujo</a></li>
            </ul>
        </div>

        <div class="col-xs-10 col-md-8" id="intro1">
            <p>En este curso online de iniciación a la programación aprenderás a utilizar la herramienta de Scratch 2.0 para programar diferentes tipos de videojuegos y animaciones mediante el lenguaje de programación por bloques de Scratch</p>
        </div>
    </div>
</asp:Content>
